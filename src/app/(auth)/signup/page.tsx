  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="card-warm p-8 max-w-md text-center">
          ...
          <p className="text-warm-600 mb-6">
            ...
            activate your account and start tracking your cub&apos;s journey.
          </p>
          <Link href="/login">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-warm-500 hover:text-warm-700 text-sm mb-8 transition-colors"
        >
        ...
        <div className="card-warm p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="font-display font-bold text-2xl text-warm-900">
                Create your account
              </h1>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-3 text-warm-500">or use email</span>
            </div>
          </div>
